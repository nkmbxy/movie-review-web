        ...
        <Grid item style={{ width: "60%" }}>
          ...
          >
            <Grid item xs={8} sx={{ marginLeft: "390px" }}>
              ...
              >
                เป็นซีรีส์ที่อยู่ในช่วงการเรียนมหาลัย
                นางเอกเรียนเกี่ยวกับบัญชีและใกล้จะจบ
                ส่วนพระเอกเป็นคนที่ฉลาดและอัจฉริยะมาก ๆ ในด้านเกี่ยวกับฟิสิกส์
                เขาทั้งสองคนรู้จักกันเพราะอุบัติเหตุ
                และความบังเอิญก็เกิดขึ้นเมื่อแม่ของนางเอกพระเอกเป็นเพื่อนกันและมีเหตุที่ทำให้นางเอกต้องมาอาศัยอยู่ที่บ้านของพระเอกและเรื่องราววุ่น
              ...
              <Grid item sx={{ marginLeft: "50px" }}>
                ...
                <Grid>
                  <Dialog open={open} onClose={handleClose}>
                    <IconButton
                      onClick={handleClose}
                      sx={{ marginLeft: "545px", marginTop: "1px" }}
                    >
                      <CloseIcon />
                    </IconButton>
                    <DialogTitle
